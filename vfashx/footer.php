			...
			<div class="row">
				...
				<div class="col-md-6 ">
					<div class="single">
						...
						if ($error_message1 != '') {
							$_SESSION['error_message'] = $error_message1;
							// echo "<script>alert('" . $error_message1 . "')</script>";
						}
						if ($success_message1 != '') {
							$_SESSION['success_message'] = $success_message1;
...
<script>
	...
	let x = setInterval(function() {
		...
		seconds.innerHTML = x + "<br><span>Giây<seconds>";
...
<script>
	...
	?>
		...
		alertify.warning('<?= $_SESSION['error_message']; ?>');
	<?php
