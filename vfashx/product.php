...
if (isset($_POST['form_add_to_cart'])) {
    ...
    if ($_POST['p_qty'] > $current_p_qty) :
        ...
        $_SESSION['error_message'] = 'Sorry! There are only ' . $current_p_qty . ' item(s) in stock';
?>
...
<?php
        ...
        if (isset($_SESSION['cart_p_id'])) {
            ...
            if ($added == 1) {
                ...
                $_SESSION['error_message'] = 'This product is already added to the shopping cart.';
            } else {
                ...
                $_SESSION['success_message'] = 'Product is added to the cart successfully!';
            }
        } else {
                ...
                <div class="product">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="p-review" style="font-size: 20px;">
                                <div class="rating">
                                    <?php
                                    if ($avg_rating == 0) {
                                        echo '';
                            ...
                            <div class="p-short-des" style="font-size: 20px;">
                                <p style="font-size: 20px;"><?php echo $p_short_description; ?></p>
                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="review" style="margin-top: -30px;">
                                    ...
                                    <div class="review-form">
                                        ...
                                        if ($success_message != '') {
                                            ...
                                            $_SESSION['success_message'] = LANG_VALUE_163;
                                        }
                                        ?>
