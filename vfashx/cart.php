...
if (isset($_POST['form1'])) {
    ...
    for ($i = 1; $i <= count($arr1); $i++) {
        ...
        if ($table_quantity[$temp_index] < $arr2[$i]) {
            $allow_update = 0;
            $error_message .= 'The quantity "' . $arr2[$i] . '" items are not available for "' . $arr3[$i] . '"\n';
        } else {
    ...
    if ($allow_update == 0) {
        ...
        $_SESSION['success_message'] = 'All Items Quantity Update is Successful!';
    }
}
?>
                                ...
                                <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a onclick="confirmation(event)" href="cart-item-delete.php?id=<?php echo $arr_cart_p_id[$i]; ?>&size=<?php echo $arr_cart_size_id[$i]; ?>&color=<?php echo $arr_cart_color_id[$i]; ?>" class="trash">
                                                <i class="fa fa-trash" style="color:red;">
                                                </i>
                                            </a>
