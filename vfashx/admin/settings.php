...
if (isset($_POST['form11'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE tbl_date SET date=?, month=?, year=?");
    $statement->execute(array($_POST['date'], $_POST['month'], $_POST['year']));
    $success_message = 'Contact form settings information is updated successfully.';
}
        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab_11" data-toggle="tab">Sales of the days</a></li>
